...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
      ...
      json['flagOne'] as String,
      json['flagTwo'] as String,
      json['flagThree'] as String,
      json['flagFour'] as String,
      json['id'] as String,
