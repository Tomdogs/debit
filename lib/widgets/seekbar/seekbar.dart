...
//      progressColor?.value ?? Theme.of(context).accentColor; luo 修改的
...
//            progressColor: Colors.red,
  ...
  void _onTapUp(TapUpDetails tapDetails) {
    ...
    setState(() {
      ...
      _setValue(touchPoint:touchPoint.dx);
  ...
  void _setValue({double touchPoint = 0,double update_e = 0}) {

    ///这个是当前的进度 从0-1
    if(touchPoint != 0){
      ///手触摸
      _value = touchPoint / context.size.width;
    }else{
      ///点击 加和减
      _value += update_e;
    }
    ...
    if (widget.onValueChanged != null) {
      ProgressValue v = ProgressValue(progress: _value, value:realValue.ceil().floorToDouble());
      ...
      children: <Widget>[
        ...
        new Expanded(
          ...
          child: new GestureDetector(
            child: new Padding(
              ...
              child: new Icon(Icons.remove_circle_outline,color: Colors.white,size: 30,),
            ),
            onTap: (){
              setState(() {
                _setValue(update_e:-e);
              });
            },
          ),
        ),
        ...
        new Expanded(
            ...
            child: new Container(
              ...
              child: new Column(
                children: <Widget>[
                  _buildSeekBar(context, _value, _min, _max),
                      ...
                      children: <Widget>[
                        new Expanded(
                          child: new Row(
                            ...
                            children: <Widget>[
                              Text('${_min.toString()}元',style: new TextStyle(color: Colors.white,fontSize: 12))
                            ],
                          ),
                        ),
                        new Expanded(
                          child: new Row(
                            ...
                            children: <Widget>[
                              Text('${_max.toString()}元',style: new TextStyle(color: Colors.white,fontSize: 12))
                            ],
                          ),
                        ),
                      ],
        ...
        new Expanded(
          ...
          child: new GestureDetector(
            child: new Padding(
                padding: EdgeInsets.only(bottom: 20),
                child: new Icon(Icons.add_circle_outline,color: Colors.white,size: 30,),
            ),
            onTap: (){
              setState(() {
                _setValue(update_e:e);
